...
export default function MiddleEasternCuisine() {
  ...
  const recipes = [
    { name: 'Hummus', pic: 'Middle-Eastern/Hummus.png', tags: ['🥦 Veg', '🍔 High-Calorie'],disc:'Delicious Indian recipes with rich spices and flavors.', type: 'Veg',cal:'High-Calorie' },
    { name: 'Kebabs', pic: 'Middle-Eastern/Kebabs.png', tags: ['🍗 Non-Veg', '🍔 High-Calorie', '👨‍👩‍👧Family Friendly'],disc:'Delicious Indian recipes with rich spices and flavors.', type: 'Non-Veg',cal:'High-Calorie' },
  ];
    ...
    <div className="bg-dark text-white min-vh-100">
      ...
      <header className="text-center bg-dark text-light py-5 position-relative rounded-2" style={{ background:'#f8f9fa' }}>
        <img style={{width:'1000px',height:'200px',objectFit:'cover'}}
          src="/Middle-Eastern/Middle-Easternback.png"
          alt="Fast Food"
          layout="fill"
        ...
        <div style={{position:'relative',marginTop:'-150px',textShadow:'15px 15px 15px black'}} className="position-relative z-1">
          <h1 className="display-4 fw-bold">Middle-Eastern Recipe</h1>
          <p className="lead">Rich, spicy, and full of flavor – explore traditional recipes!</p>
        </div>
      </header>
        ...
        <div className="container">
          <p className="mb-0">
            <span className="badge bg-danger me-2">🔥 Trending:</span>
             Kebabs &nbsp;|&nbsp; 🍴 30-min Meals &nbsp;|&nbsp; 👨‍👩‍👧 Family Friendly &nbsp;|&nbsp; 🥗 Healthy Choices
          </p>
        </div>
      </section>
