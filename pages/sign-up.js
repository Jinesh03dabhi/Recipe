...
export default function signin() {
  ...
  const handleSubmit = (e) => {
    ...
    if (!email || !password) {
     ...
     setMessage('Please fill match password.');
    } else {
  ...
  return (
    ...
    <div className="container py-5" style={{width:'50%'}}>
      ...
      <h2 className="text-center mb-4">🔐 Sign-Up to Recipe.com</h2>
      <form onSubmit={handleSubmit} className="shadow p-4 rounded bg-light">
        ...
        <button type="submit" className="btn btn-dark mb-3 w-100">Submit</button>
