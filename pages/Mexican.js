...
export default function MexicanCuisine() {
  ...
  const recipes = [
    { name: 'Churros', pic: 'Mexican/Churros.png', tags: ['🥦 Veg', '🍔 High-Calorie'],disc:'Simple, high-quality ingredients with a focus on olive oil, pasta, and herbs.', type: 'Veg',cal:'High-Calorie' },
    { name: 'Tacos', pic: 'Mexican/Tacos.png', tags: ['🍗 Non-Veg', '🍔 High-Calorie', '👨‍👩‍👧Family Friendly'],disc:'Bold, spicy, and flavorful — loaded with beans, corn, and chillies.', type: 'Non-Veg',cal:'High-Calorie' },
  ];
    ...
    <div className="bg-dark text-white min-vh-100">
      ...
      <header className="text-center bg-dark text-light py-5 position-relative rounded-2" style={{ background:'#f8f9fa' }}>
        ...
        <div style={{position:'relative',marginTop:'-150px',textShadow:'15px 15px 15px black'}} className="position-relative z-1">
          <h1 className="display-4 fw-bold">🇲🇽 Mexican Recipe</h1>
          <p className="lead">Bold, spicy, and flavorful — loaded with beans, corn, and chillies.</p>
        </div>
      </header>
        ...
        <div className="container">
          <p className="mb-0">
            <span className="badge bg-danger me-2">🔥 Trending:</span>
             Tacos  &nbsp;|&nbsp; 🍴 30-min Meals &nbsp;|&nbsp; 👨‍👩‍👧 Family Friendly &nbsp;|&nbsp; 🥗 Healthy Choices
          </p>
        </div>
      </section>
