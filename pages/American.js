...
export default function AmericanCuisine() {
  ...
  const recipes = [
    { name: 'Burgers', pic: 'American/Burgers.png', tags: ['🍗 Non-Veg', '🍔 High-Calorie'],disc:'Hearty meals with bold flavors; famous for fast food, grills, and comfort food.', type: 'Non-Veg',cal:'High-Calorie' },
    { name: 'Mac & Cheese', pic: 'American/Mac & Cheese.png', tags: ['🥦 Veg', '🍔 High-Calorie', '👨‍👩‍👧Family Friendly'],disc:'Hearty meals with bold flavors; famous for fast food, grills, and comfort food.', type: 'Veg',cal:'High-Calorie' },
  ];
    ...
    <div className="bg-dark text-white min-vh-100">
      ...
      <header className="text-center bg-dark text-light py-5 position-relative rounded-2" style={{ background:'#f8f9fa' }}>
        ...
        <div style={{position:'relative',marginTop:'-150px',textShadow:'15px 15px 15px black'}} className="position-relative z-1">
          <h1 className="display-4 fw-bold">🇺🇸 American</h1>
          <p className="lead">Hearty meals with bold flavors; famous for fast food, grills, and comfort food.</p>
        </div>
      </header>
        ...
        <div className="container">
          <p className="mb-0">
            <span className="badge bg-danger me-2">🔥 Trending:</span>
             Burgers &nbsp;|&nbsp; 🍴 30-min Meals &nbsp;|&nbsp; 👨‍👩‍👧 Family Friendly &nbsp;|&nbsp; 🥗 Healthy Choices
          </p>
        </div>
      </section>
