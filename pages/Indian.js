...
export default function IndianCuisine() {
  ...
  const recipes = [
    { name: 'Butter Chicken', pic: 'indian/butter-chicken.png', tags: ['🍗 Non-Veg', '🍔 High-Calorie'],disc:'Delicious Indian recipes with rich spices and flavors.', type: 'Non-Veg',cal:'High-Calorie' },
    { name: 'Masala Dosa', pic: 'indian/dosa.png', tags: ['🥦 Veg', '🍃 Low-Calorie', '👨‍👩‍👧Family Friendly'],disc:'Delicious Indian recipes with rich spices and flavors.', type: 'Veg',cal:'Low-Calorie' },
  ];
    ...
    <div className="bg-dark text-white min-vh-100">
      ...
      <header className="text-center bg-dark text-light py-5 position-relative rounded-2" style={{ background:'#f8f9fa' }}>
        ...
        <div style={{position:'relative',marginTop:'-150px',textShadow:'15px 15px 15px black'}} className="position-relative z-1">
          <h1 className="display-4 fw-bold">🇮🇳 Indian Recipe</h1>
        ...
        <div className="container">
          <p className="mb-0">
            <span className="badge bg-danger me-2">🔥 Trending:</span>
             Masala Dosa &nbsp;|&nbsp; 🍴 30-min Meals &nbsp;|&nbsp; 👨‍👩‍👧 Family Friendly &nbsp;|&nbsp; 🥗 Healthy Choices
          </p>
        </div>
      </section>
