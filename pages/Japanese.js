...
export default function JapaneseCuisine() {
  ...
  const recipes = [
    { name: 'Miso Soup', pic: 'Japanese/Miso Soup.png', tags: ['🥦 Veg', '🍃 Low-Calorie','👨‍👩‍👧Family Friendly'],disc:' Clean, minimalist, and focused on presentation. Known for seasonal, fresh ingredients.', type: 'Veg',cal:'High-Calorie' },
    { name: 'Sushi', pic: 'Japanese/Sushi.png', tags: ['🍗 Non-Veg', '🍽️ Moderate-Calorie', '👨‍👩‍👧Family Friendly'],disc:' Clean, minimalist, and focused on presentation. Known for seasonal, fresh ingredients.', type: 'Non-Veg',cal:'High-Calorie' },
  ];
    ...
    <div className="bg-dark text-white min-vh-100">
      ...
      <header className="text-center bg-dark text-light py-5 position-relative rounded-2" style={{ background:'#f8f9fa' }}>
        ...
        <div style={{position:'relative',marginTop:'-150px',textShadow:'15px 15px 15px black'}} className="position-relative z-1">
          <h1 className="display-4 fw-bold">🇯🇵 Japanese</h1>
          <p className="lead">Clean, minimalist, and focused on presentation. Known for seasonal, fresh ingredients.</p>
        </div>
      </header>
        ...
        <div className="container">
          <p className="mb-0">
            <span className="badge bg-danger me-2">🔥 Trending:</span>
             Sushi &nbsp;|&nbsp; 🍴 30-min Meals &nbsp;|&nbsp; 👨‍👩‍👧 Family Friendly &nbsp;|&nbsp; 🥗 Healthy Choices
          </p>
        </div>
      </section>
