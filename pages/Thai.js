...
export default function FrenchCuisine() {
  ...
  const recipes = [
    { name: 'Pad Thai', pic: 'Thai/Pad Thai.png', tags: ['🍗 Non-Veg', '🍔 High-Calorie'],disc:' A balance of sweet, sour, salty, and spicy. Coconut milk and lemongrass are staples.', type: 'Non-Veg',cal:'High-Calorie' },
    { name: 'Tom Yum Soup', pic: 'Thai/Tom Yum Soup.png', tags: ['🍗 Non-Veg', '🍔 High-Calorie', '👨‍👩‍👧Family Friendly'],disc:'Delicious recipes with rich spices and flavors.', type: 'Non-Veg',cal:'High-Calorie' },
  ];
    ...
    <div className="bg-dark text-white min-vh-100">
      ...
      <header className="text-center bg-dark text-light py-5 position-relative rounded-2" style={{ background:'#f8f9fa' }}>
        ...
        <div style={{position:'relative',marginTop:'-150px',textShadow:'15px 15px 15px black'}} className="position-relative z-1">
          <h1 className="display-4 fw-bold">🇹🇭 Thai Recipe</h1>
          <p className="lead"> A balance of sweet, sour, salty, and spicy. Coconut milk and lemongrass are staples.</p>
        </div>
      </header>
        ...
        <div className="container">
          <p className="mb-0">
            <span className="badge bg-danger me-2">🔥 Trending:</span>
             Pad Thai &nbsp;|&nbsp; 🍴 30-min Meals &nbsp;|&nbsp; 👨‍👩‍👧 Family Friendly &nbsp;|&nbsp; 🥗 Healthy Choices
          </p>
        </div>
      </section>
