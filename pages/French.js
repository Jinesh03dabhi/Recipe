...
export default function FrenchCuisine() {
  ...
  const recipes = [
    { name: 'Croissant', pic: 'French/Croissant.png', tags: ['🥦 Veg', '🍔 High-Calorie'],disc:'Delicious Indian recipes with rich spices and flavors.', type: 'Veg',cal:'High-Calorie' },
    { name: 'Quiche', pic: 'French/Quiche.png', tags: ['🥦 Veg', '🍔 High-Calorie', '👨‍👩‍👧Family Friendly'],disc:'Delicious recipes with rich spices and flavors.', type: 'Veg',cal:'High-Calorie' },
  ];
    ...
    <div className="bg-dark text-white min-vh-100">
      ...
      <header className="text-center bg-dark text-light py-5 position-relative rounded-2" style={{ background:'#f8f9fa' }}>
        ...
        <div style={{position:'relative',marginTop:'-150px',textShadow:'15px 15px 15px black'}} className="position-relative z-1">
          <h1 className="display-4 fw-bold">🇫🇷 French Recipe</h1>
        ...
        <div className="container">
          <p className="mb-0">
            <span className="badge bg-danger me-2">🔥 Trending:</span>
             Croissant &nbsp;|&nbsp; 🍴 30-min Meals &nbsp;|&nbsp; 👨‍👩‍👧 Family Friendly &nbsp;|&nbsp; 🥗 Healthy Choices
          </p>
        </div>
      </section>
