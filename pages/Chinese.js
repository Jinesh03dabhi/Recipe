...
export default function ChineseCuisine() {
  ...
  const recipes = [
    { name: 'Chow Mein', pic: 'Chinese/Chow Mein.png', tags: ['🥦 Veg', '🍔 High-Calorie','👨‍👩‍👧Family Friendly'],disc:'A balance of taste, texture, and aroma. Famous for stir-frying and diverse sauces.', type: 'Veg',cal:'High-Calorie' },
    { name: 'Sweet & Sour Chicken', pic: 'Chinese/Sweet & Sour Chicken.png', tags: ['🍗 Non-Veg', '🍔 High-Calorie', '👨‍👩‍👧Family Friendly'],disc:'Hearty meals with bold flavors; famous for fast food, grills, and comfort food.', type: 'Non-Veg',cal:'High-Calorie' },
  ];
    ...
    <div className="bg-dark text-white min-vh-100">
      ...
      <header className="text-center bg-dark text-light py-5 position-relative rounded-2" style={{ background:'#f8f9fa' }}>
        ...
        <div style={{position:'relative',marginTop:'-150px',textShadow:'15px 15px 15px black'}} className="position-relative z-1">
          <h1 className="display-4 fw-bold">🇨🇳 Chinese</h1>
          <p className="lead"> A balance of taste, texture, and aroma. Famous for stir-frying and diverse sauces.</p>
        </div>
      </header>
        ...
        <div className="container">
          <p className="mb-0">
            <span className="badge bg-danger me-2">🔥 Trending:</span>
             Chow Mein &nbsp;|&nbsp; 🍴 30-min Meals &nbsp;|&nbsp; 👨‍👩‍👧 Family Friendly &nbsp;|&nbsp; 🥗 Healthy Choices
          </p>
        </div>
      </section>
